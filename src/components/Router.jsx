...
const NavRoutes = () => (
    <Fragment>
        <Router>
            ...
            <main>
                <Switch>
                    <ScrollToTopRoute exact path="/" component={withTracker(Home)} />
                    <ScrollToTopRoute exact path="/portfolio" component={withTracker(Portfolio)} />
                    ...
                    <ScrollToTopRoute exact path="/blog" component={withTracker(Blog)}/>
